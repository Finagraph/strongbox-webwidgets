...
/** Specifies the list of Workbooks that can be downloaded. |Enum Value|Description| |--|--| |FullAnalysis|The Workbook contains the full financial analysis.| */
export type WorkbookVariant = "FullAnalysis";
...
export class YearEnd implements IYearEnd {
    /** A number between 1-31 representing the day of the month the year ends. May be null, in which it is reasonable to assume that the last day of the month represents the end of the year. */
...
/** Defines a set of tags providing additional information about a Name. |Enum Value|Description| |--|--| |Legal|The name is the legal name for the Organization.| |Dba|The name is used as a trade name. Short for "Doing Business As".| |Person|The name of a person.| |Organization|The name of an organization.| */
export type NameTag = "Legal" | "Dba" | "Person" | "Organization";

/** Models a business or person name. */
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["names"])) {
                ...
                for (let item of _data["names"])
                    this.names!.push(Name.fromJS(item));
            }
...
/** Used to filter to currently open receivables or payables, to historical receivables or payables, or to include both. |Enum Value|Description| |--|--| |Open|Only transactions with an outstanding balance or an unapplied credit will be included in the response.| |Closed|Only historic invoices and credits are to be included in the response.| |OpenOrClosed|Both open and closed invoices and credits will be included in the response.| */
export type OpenOrClosedOption = "Open" | "Closed" | "OpenOrClosed";
...
/** A receivable or payable transaction is considered Open if it has an outstanding amount, otherwise it is Closed. |Enum Value|Description| |--|--| |Open|The receivable or payable transaction does has an outstanding amount and is included in reports related to open receivables or payables.| |Closed|The receivable or payable transaction does not have an outstanding amount and represents a historical receivable or payable.| */
export type ReceivableOrPayableStatus = "Open" | "Closed";
...
export class ReceivableOrPayable implements IReceivableOrPayable {
    ...
    /** A positive or negative integer representing the number of days before or after the due date relative to the financial reporting date. For example, the age one day before the due date is -1 and the age one day after the due date is 1. If a due date is not specified then the days from due date is defined to be 0. */
    daysFromDueDate!: number;
    /** The date at which time an invoice is due, if a due date is specified. */
    dueDate?: string | undefined;
    /** If the status is Open will be "Current", "1-30 days", "31-60 days", "91-120 days", "61-90 days", "> 120 days", or "Unapplied Credit". If the status is Closed, will be null. */
    dueDateAgingBucket?: string | undefined;
    /** An identifier for the relationship associated with the transaction, if specified. */
    relationshipId?: string | undefined;
    /** The name associated with the transaction, if specified. */
    relationshipName?: string | undefined;
    status!: ReceivableOrPayableStatus;
    ...
    /** If the status is Open will be "< 31 days", "31-60 days", "61-90 days", "91-120 days", "> 120 days", or "Unapplied Credit". If the status is Closed, will be null. */
    transactionDateAgingBucket?: string | undefined;
    /** An identifier for the transaction. */
    transactionId!: string;
    /** The type of the transaction, as specified by the datasource. */
    transactionType?: string | undefined;
    /** A user-editable reference number. This is sometimes the easiest way for the end-user to locate the receivable or payable transaction in the accounting system. */
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.dueDateAgingBucket = _data["dueDateAgingBucket"];
            ...
            this.transactionDateAgingBucket = _data["transactionDateAgingBucket"];
    ...
    toJSON(data?: any) {
        ...
        data["dueDateAgingBucket"] = this.dueDateAgingBucket;
        ...
        data["transactionDateAgingBucket"] = this.transactionDateAgingBucket;
...
export class PayablesList implements IPayablesList {
    ...
    asOf!: string;
    /** The set of payable transactions. */
...
export class ReceivablesList implements IReceivablesList {
    /** The date corresponding to the information about the receivable transactions. */
    asOf!: string;
    /** The set of receivable transactions. */
    transactions!: ReceivableOrPayable[];
...
export class TransactionEntry implements ITransactionEntry {
    ...
    /** An identifier for the transaction entry that is unique within the scope of the transaction. */
    id!: string;
...
/** Specifies the types of line items that can appear in a financial statement. |Enum Value|Description| |--|--| |CaptionOnly|The line item represents a caption/label only and does not have any [other] column data.| |Amount|The line item contains amounts by reporting period.| |Subtotal|The line item contains subtotals by reporting period. This type of line item is typically presented with a single line above it.| |GrandTotal|The line item contains grand totals by reporting period. This type of line item is typically presented with a double line above it.| */
export type LineItemType = "CaptionOnly" | "Amount" | "Subtotal" | "GrandTotal";
...
export class LineItem implements ILineItem {
    ...
    init(_data?: any) {
        if (_data) {
            this.account = _data["account"] ? AccountReference.fromJS(_data["account"]) : <any>undefined;
...
export class AgingBucket implements IAgingBucket {
    ...
    label!: string;
    /** The maximum age of receivables or payables included in this aging bucket (inclusive). May be null for aging bucket's of like "> 120". */
    maximumAge?: number | undefined;
    /** The minimum age of receivables or payables included in this aging bucket (inclusive). May be null for aging bucket's of like "< 31". */
...
/** Specifies whether financial data was prepared for payables or receivables. |Enum Value|Description| |--|--| |Receivables|Related to receivables.| |Payables|Related to payables.| */
export type ReceivablesOrPayables = "Receivables" | "Payables";

/** Models receivables or payables concentration as of a specific date. */
export class AgingReport implements IAgingReport {
    /** Data for each aging bucket. */
    agingBuckets!: AgingBucket[];
    agingMethod!: AgingMethod;
    /** The date corresponding to the receivables or payables concentration data. */
    asOf!: string;
    reportKind!: ReceivablesOrPayables;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.asOf = _data["asOf"];
            this.reportKind = _data["reportKind"];
    ...
    toJSON(data?: any) {
        ...
        data["asOf"] = this.asOf;
        data["reportKind"] = this.reportKind;
...
/** Models a data point for the receivables or payables concentration report. */
export class ConcentrationByRelationship implements IConcentrationByRelationship {
    amountOutstanding!: DoubleEntryAmount;
    /** A label for the data point, which will typically be the name for the receivable or payable relationship. */
    label!: string;
    /** An identifier for the receivable or payable relationship corresponding to this data point. May be null or empty if the data point represents a summary of all other receivables or payables. */
    relationshipId?: string | undefined;

    constructor(data?: IConcentrationByRelationship) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ConcentrationByRelationship {
        data = typeof data === 'object' ? data : {};
        let result = new ConcentrationByRelationship();
        result.init(data);
        return result;
    }
    ...
    clone(): ConcentrationByRelationship {
        const json = this.toJSON();
        let result = new ConcentrationByRelationship();
        result.init(json);
        return result;
...
/** Models a data point for the receivables or payables concentration report. */
export interface IConcentrationByRelationship {
    amountOutstanding: DoubleEntryAmount;
    /** A label for the data point, which will typically be the name for the receivable or payable relationship. */
    label: string;
    /** An identifier for the receivable or payable relationship corresponding to this data point. May be null or empty if the data point represents a summary of all other receivables or payables. */
...
/** Models receivables or payables concentration as of a specific date. */
export class ConcentrationReport implements IConcentrationReport {
    /** The date corresponding to the receivables or payables concentration data. */
    asOf!: string;
    /** Receivable or payable concentration data as of the requested date. */
    concentration!: ConcentrationByRelationship[];
    reportKind!: ReceivablesOrPayables;
    /** If specified, the concentration data will contain data points only for the top N relationships plus one data point representing all other receivables or payables outstanding. */
    top!: number;
    totalAmountOutstanding!: DoubleEntryAmount;

    constructor(data?: IConcentrationReport) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.asOf = _data["asOf"];
            if (Array.isArray(_data["concentration"])) {
                this.concentration = [] as any;
                for (let item of _data["concentration"])
                    this.concentration!.push(ConcentrationByRelationship.fromJS(item));
            }
            this.reportKind = _data["reportKind"];
            this.top = _data["top"];
            this.totalAmountOutstanding = _data["totalAmountOutstanding"] ? DoubleEntryAmount.fromJS(_data["totalAmountOutstanding"]) : new DoubleEntryAmount();
    ...
    static fromJS(data: any): ConcentrationReport {
        data = typeof data === 'object' ? data : {};
        let result = new ConcentrationReport();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["asOf"] = this.asOf;
        if (Array.isArray(this.concentration)) {
            data["concentration"] = [];
            for (let item of this.concentration)
                data["concentration"].push(item.toJSON());
        }
        data["reportKind"] = this.reportKind;
        data["top"] = this.top;
        data["totalAmountOutstanding"] = this.totalAmountOutstanding ? this.totalAmountOutstanding.toJSON() : <any>undefined;
...
/** Models receivables or payables concentration as of a specific date. */
export interface IConcentrationReport {
    /** The date corresponding to the receivables or payables concentration data. */
    asOf: string;
    /** Receivable or payable concentration data as of the requested date. */
    concentration: ConcentrationByRelationship[];
...
/** Specifies the time period for which accounting and other financial data is prepared. |Enum Value|Description| |--|--| |Days|The reporting period is daily.| |WeeksStartingSunday|The reporting period is weeks starting Sunday.| |Months|The reporting period is monthly.| |CalendarQuarters|The reporting period is quarterly; aligned to Gregorian calendar year.| |CalendarYears|The reporting period is annual; aligned to the Gregorian calendar year.| |FiscalQuarters|The reporting period is quarterly; aligned to the fiscal year for the accounting entity.| |FiscalYears|The reporting period is annual; aligned to the fiscal year for the accounting entity.| */
export type TransactionalReportingPeriod = "Days" | "WeeksStartingSunday" | "Months" | "CalendarQuarters" | "CalendarYears" | "FiscalQuarters" | "FiscalYears";

/** Models totals for outstanding receivables or payables for a specific reporting period. */
export class ReportedReceivablesOrPayables implements IReportedReceivablesOrPayables {
    amountClosed!: DoubleEntryAmount;
    amountOpened!: DoubleEntryAmount;
    endingAmountOutstanding!: DoubleEntryAmount;
    /** The last day for the reporting period (inclusive). */
    fromDate!: string;
    netChange!: DoubleEntryAmount;
    startingAmountOustanding!: DoubleEntryAmount;
    /** The first day of the reporting period (inclusive). */
    toDate!: string;

    constructor(data?: IReportedReceivablesOrPayables) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.amountClosed = new DoubleEntryAmount();
            this.amountOpened = new DoubleEntryAmount();
            this.endingAmountOutstanding = new DoubleEntryAmount();
            this.netChange = new DoubleEntryAmount();
            this.startingAmountOustanding = new DoubleEntryAmount();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.amountClosed = _data["amountClosed"] ? DoubleEntryAmount.fromJS(_data["amountClosed"]) : new DoubleEntryAmount();
            this.amountOpened = _data["amountOpened"] ? DoubleEntryAmount.fromJS(_data["amountOpened"]) : new DoubleEntryAmount();
            this.endingAmountOutstanding = _data["endingAmountOutstanding"] ? DoubleEntryAmount.fromJS(_data["endingAmountOutstanding"]) : new DoubleEntryAmount();
            this.fromDate = _data["fromDate"];
            this.netChange = _data["netChange"] ? DoubleEntryAmount.fromJS(_data["netChange"]) : new DoubleEntryAmount();
            this.startingAmountOustanding = _data["startingAmountOustanding"] ? DoubleEntryAmount.fromJS(_data["startingAmountOustanding"]) : new DoubleEntryAmount();
            this.toDate = _data["toDate"];
        }
    }

    static fromJS(data: any): ReportedReceivablesOrPayables {
        data = typeof data === 'object' ? data : {};
        let result = new ReportedReceivablesOrPayables();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["amountClosed"] = this.amountClosed ? this.amountClosed.toJSON() : <any>undefined;
        data["amountOpened"] = this.amountOpened ? this.amountOpened.toJSON() : <any>undefined;
        data["endingAmountOutstanding"] = this.endingAmountOutstanding ? this.endingAmountOutstanding.toJSON() : <any>undefined;
        data["fromDate"] = this.fromDate;
        data["netChange"] = this.netChange ? this.netChange.toJSON() : <any>undefined;
        data["startingAmountOustanding"] = this.startingAmountOustanding ? this.startingAmountOustanding.toJSON() : <any>undefined;
        data["toDate"] = this.toDate;
        return data;
    }

    clone(): ReportedReceivablesOrPayables {
        const json = this.toJSON();
        let result = new ReportedReceivablesOrPayables();
        result.init(json);
        return result;
...
/** Models totals for outstanding receivables or payables for a specific reporting period. */
export interface IReportedReceivablesOrPayables {
    amountClosed: DoubleEntryAmount;
    amountOpened: DoubleEntryAmount;
    endingAmountOutstanding: DoubleEntryAmount;
    /** The last day for the reporting period (inclusive). */
...
/** Models totals for payables by reporting period. */
export class PayablesTotals implements IPayablesTotals {
    /** An identifier for a specific receivable or payable relationship corresponding to the data. Will be null if the data represents overall receivables or payables totals. */
    relationshipId?: string | undefined;
    /** Receivable or payable transaction totals by reporting period. */
    reportedTotals!: ReportedReceivablesOrPayables[];
    reportingPeriod?: TransactionalReportingPeriod;

    constructor(data?: IPayablesTotals) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["reportedTotals"])) {
                this.reportedTotals = [] as any;
                for (let item of _data["reportedTotals"])
                    this.reportedTotals!.push(ReportedReceivablesOrPayables.fromJS(item));
            }
            this.reportingPeriod = _data["reportingPeriod"];
        }
    }

    static fromJS(data: any): PayablesTotals {
        data = typeof data === 'object' ? data : {};
        let result = new PayablesTotals();
        result.init(data);
        return result;
    }
...
/** Models totals for payables by reporting period. */
export interface IPayablesTotals {
    /** An identifier for a specific receivable or payable relationship corresponding to the data. Will be null if the data represents overall receivables or payables totals. */
    relationshipId?: string | undefined;
    /** Receivable or payable transaction totals by reporting period. */
    reportedTotals: ReportedReceivablesOrPayables[];
...
/** Models totals for receivables by reporting period. */
export class ReceivablesTotals implements IReceivablesTotals {
    /** An identifier for a specific receivable or payable relationship corresponding to the data. Will be null if the data represents overall receivables or payables totals. */
    relationshipId?: string | undefined;
    /** Receivable or payable transaction totals by reporting period. */
    reportedTotals!: ReportedReceivablesOrPayables[];
    ...
    constructor(data?: IReceivablesTotals) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ReceivablesTotals {
        data = typeof data === 'object' ? data : {};
        let result = new ReceivablesTotals();
        result.init(data);
        return result;
    }
...
/** Models totals for receivables by reporting period. */
export interface IReceivablesTotals {
    /** An identifier for a specific receivable or payable relationship corresponding to the data. Will be null if the data represents overall receivables or payables totals. */
    relationshipId?: string | undefined;
    /** Receivable or payable transaction totals by reporting period. */
    reportedTotals: ReportedReceivablesOrPayables[];
...
/** Specificies a unit of time for scheduling. |Enum Value|Description| |--|--| |Weeks|The unit of time is weeks. Weeks are considered to start Sunday for scheduling purposes.| |Months|The unit of time is months.| */
